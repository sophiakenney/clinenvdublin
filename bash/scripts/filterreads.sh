...
TR="/your/path/to/trimmed_out/1.0-trimmed" 
cd ${TR}
...
K2="/your/path/to/k2out/2.0-kraken2" # kraken2 output directory
FILT="/your/path/to/k2filtered/2.1-k2filteredentero" # extracted reads output directory
